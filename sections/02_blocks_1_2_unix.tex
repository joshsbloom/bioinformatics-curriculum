...
Every non-default tool named anywhere in this curriculum has install commands (macOS and Linux) and an official link in \textbf{Appendix~A}. Flip to it the moment you hit a command that isn't on your machine --- don't guess.
\end{tipbox}
