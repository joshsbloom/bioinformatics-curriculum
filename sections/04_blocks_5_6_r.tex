...
R is not installed by default on macOS or most Linux distributions. Download the pre-built binary for your OS/architecture from CRAN (\url{https://cran.r-project.org}), then install RStudio Desktop for a comfortable IDE (\url{https://posit.co/download/rstudio-desktop/}). See Appendix~A for more.
\end{tipbox}
